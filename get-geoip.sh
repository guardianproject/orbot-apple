...
then
    curl -Lo ./TorVPN/geoip https://gitweb.torproject.org/tor.git/plain/src/config/geoip?h=tor-0.4.6.7
    curl -Lo ./TorVPN/geoip6 https://gitweb.torproject.org/tor.git/plain/src/config/geoip6?h=tor-0.4.6.7
fi
